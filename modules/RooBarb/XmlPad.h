	...
	public:
		...
		XmlPad( XmlConfig &_cfg, string _nodePath, int _nGridX = 6, int _nGridY = 6 ){
			...
			if ( _cfg.exists( _nodePath ) ) {
                ...
                LOG_F( INFO, "x=(%f, %f), y=(%f, %f)", x1, x2, y1, y2 );
